...
export const authRegister: AppThunk = (authData: TAuthRegister) => {
...
export const authLogin: AppThunk = (loginData: TAuth) => {
  return function (dispatch: AppDispatch) {
...
export const passwordReset: AppThunk = (resetData: TPasswordReset) => {
  return function (dispatch: AppDispatch) {
...
export const passwordResetReset: AppThunk = (resetData: TPasswordResetReset) => {
  return function (dispatch: AppDispatch) {
...
export const authLogout: AppThunk = (logoutData: TToken) => {
  return function (dispatch: AppDispatch) {
...
export const updateUser: AppThunk = (userData: TUserData) => {
  return function (dispatch: AppDispatch) {
